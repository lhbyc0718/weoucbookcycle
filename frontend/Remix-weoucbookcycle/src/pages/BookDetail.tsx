...
export const BookDetail: React.FC<BookDetailProps> = ({ 
  ...
  const handleEvaluation = (isGood: boolean) => {
    if (onEvaluate) {
      ...
      alert(`Thank you for your feedback! You rated the seller as ${isGood ? 'Good' : 'Bad'}.`);
    }
  };
        ...
        <div className="mt-6">
          ...
          >
            ...
            <div className="flex flex-col items-end">
              ...
              <span className="text-[10px] text-slate-500 mt-1">Trust Score: {seller.trustScore}</span>
            </div>
          </div>
        </div>
      ...
      {showEvaluateModal && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
          ...
          <div className="relative bg-slate-900 border border-white/10 rounded-2xl p-6 w-full max-w-sm shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <h3 className="text-xl font-bold text-white mb-2 text-center">Evaluate Seller</h3>
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <span className="text-sm font-medium text-slate-300 group-hover:text-red-400">Bad</span>
              </button>
              ...
              >
                ...
                <span className="text-sm font-medium text-slate-300 group-hover:text-green-400">Good</span>
              </button>
            </div>
          </div>
        </div>
