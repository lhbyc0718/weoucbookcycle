    ...
    <div className="flex flex-col h-full bg-slate-950 pb-24 relative overflow-hidden">
      ...
      <header className="px-4 py-6 relative z-10">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-white font-display tracking-tight">Messages</h1>
          <button 
            onClick={onShowInstructions}
            className="w-10 h-10 rounded-full bg-slate-800 hover:bg-slate-700 transition-all flex items-center justify-center border border-white/5 shadow-lg active:scale-95"
          >
      ...
      <div className="flex-1 overflow-y-auto px-4 relative z-10">
        <div className="mb-8">
          <h2 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-4">Active Now</h2>
        ...
        <div>
          <h2 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-4">Recent Chats</h2>
